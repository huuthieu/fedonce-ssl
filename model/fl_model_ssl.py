...
class VerticalFLModel:
    ...
    def train_local_party_ssl(self, ep, party_id, X, y, model, unalign_index):
        """
        Train one local party
        :param ep: index of epochs
        :param party_id: which party
    ...
    def train_ssl(self, labeled_trainloader, unlabeled_trainloader, model, optimizer, criterion, epoch,train_iteration,  use_cuda):
